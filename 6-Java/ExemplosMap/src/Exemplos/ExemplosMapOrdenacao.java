...
public class ExemplosMapOrdenacao {
    public static void main(String[] args) {
        ...
        Set<Map.Entry<String, Livro>> meusLivros5 = new TreeSet<>(new ComparatorNroPaginas());
...
class ComparatorNroPaginas implements Comparator<Map.Entry<String, Livro>> {
